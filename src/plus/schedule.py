...
#        self.main_splitter.setSizes([0,100])
        ...
        disconnected_widget.setText(QApplication.translate('Plus', 'Login to {} to receive your roast schedule').format(f'<a href="{plusLink()}">{plus.config.app_display_name}</a>'))
            ...
            try:
                ...
                if self.aw.plus_account is None:
                    ...
                    if self.scheduled_items == []:
                        ...
                        self.remaining_message.setText(QApplication.translate('Plus', 'Schedule empty!{}Plan your schedule on {}').format('<BR><BR>', f'<a href="{schedulerLink()}">{plus.config.app_display_name}</a><br>'))
