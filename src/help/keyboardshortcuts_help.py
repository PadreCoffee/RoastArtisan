...
def content() -> str:
    ...
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','Double click on Roast Title'),QApplication.translate('HelpDlg','Graph'),QApplication.translate('HelpDlg','Open the roast in Roastlocal Cloud'),QApplication.translate('HelpDlg','Requires an Roastlocal Cloud account')])
    ...
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','Click on plus icon (when it is red)'),QApplication.translate('HelpDlg','Graph'),QApplication.translate('HelpDlg','Sync the roast with Roastlocal Cloud'),'&#160;'])
