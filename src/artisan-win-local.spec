...
if os.environ.get('APPVEYOR'):
    ...
    PYTHON = os.environ.get('PYTHON_PATH') or sys.prefix
...
a = Analysis(['artisan.py'],
             ...
             hookspath=[],
             runtime_hooks=[r'pyinstaller_hooks\rthooks\pyi_rth_mplconfig.py', r'pyinstaller_hooks\rthooks\pyi_rth_certifi.py'], # overwrites default MPL runtime hook which keeps loading font cache from (new) temp directory
